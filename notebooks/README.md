...
- Notebooks 05–08 stop when their required completed-run, reference-bundle, model, gene, or tool prerequisites are absent. No personal path substitutes synthetic resources.
...
| 08 | declared-pedigree segregation and site transmission | explicit local pedigree and compatible completed M2 runs for every member | [08_family_segregation_and_transmission.ipynb](08_family_segregation_and_transmission.ipynb) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jcollins-bioinfo/genome-evidence/blob/main/notebooks/08_family_segregation_and_transmission.ipynb) |
